...
let package = Package(
    ...
    products: [
        ...
        .library(
            name: "RDFStorage",
            targets: ["RDFStorage", "RDFStorageTests"]
        ),
    ],
    dependencies: [
...
//            linkerSettings: [.linkedLibrary("xml2"), .linkedLibrary("icu-uc")]
        ),
        .target(
            name: "RDFStorage",
...
//            ],
//            swiftSettings:[.unsafeFlags(["-I$SDKROOT/usr/include/libxml2"])],
            linkerSettings: [.linkedLibrary("xml2"), .linkedLibrary("icu4c")]
        ),
        .testTarget(
            name: "RDFStorageTests",
            dependencies: ["RDFStorage"],
            path: "Tests/RDFStorage"
        )
    ]
)
