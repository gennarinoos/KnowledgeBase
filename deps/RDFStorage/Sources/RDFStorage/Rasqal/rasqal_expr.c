                                      ...
                                      unsigned int flags)
{
  ...
  if(e) {
    ...
    e->parameters = params; params = NULL;
    e->flags = flags;
  }
 ...
 * @parameters: sequence of #rasqal_expression function parameters (or NULL)
 ...
 *
 * Takes ownership of the @args and @parameters
 * 
                               ...
                               raptor_sequence* arguments)
{
  ...
  if(e) {
    ...
    e->world = world;
    e->op = op;
    e->args = arguments; arguments = NULL;
  }
  
  tidy:
  if(arguments)
    raptor_free_sequence(arguments);
 ...
 *
 * Takes ownership of the @arg1 and @arguments
 * 
 * Return value: a new #rasqal_expression object or NULL on failure
 **/
rasqal_expression*
